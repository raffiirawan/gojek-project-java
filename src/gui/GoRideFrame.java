...
public class GoRideFrame extends javax.swing.JFrame {
    ...
    public GoRideFrame(AuthService authService, RideService rideService, TransactionService transactionService, User currentUser) {
    ...
    private void initComponents() {
        ...
        setTitle("Gojek App - GoRide");
        setResizable(false);

        // Latar belakang netral ala Gojek
        contentPanel.setBackground(new java.awt.Color(243, 244, 246));
        ...
        headerLabel.setForeground(new java.awt.Color(22, 163, 74));
        headerLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        headerLabel.setText("Pesan GoRide (Motor)");
        ...
        formPanel.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            // Kartu putih dengan border abu tipis
        ...
        pickupLabel.setForeground(new java.awt.Color(31, 41, 55));
        ...
        destinationLabel.setForeground(new java.awt.Color(31, 41, 55));
        ...
        vehicleNoteLabel.setForeground(new java.awt.Color(22, 163, 74));
        vehicleNoteLabel.setText("Kendaraan: Motor (hemat & gesit)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        distanceLabel.setForeground(new java.awt.Color(31, 41, 55));
        ...
        fareLabel.setForeground(new java.awt.Color(22, 163, 74));
        ...
        estimateButton.setPreferredSize(new Dimension(180, 36));
        estimateButton.setMaximumSize(new Dimension(220, 36));
        ...
        orderButton.setPreferredSize(new Dimension(180, 36));
        orderButton.setMaximumSize(new Dimension(220, 36));
        ...
        backButton.setMaximumSize(new Dimension(220, 30));
    ...
    private void styleButtons() {
        ButtonStyler.applySolid(estimateButton, new java.awt.Color(22, 163, 74), java.awt.Color.WHITE);
        ButtonStyler.applySolid(orderButton, new java.awt.Color(22, 163, 74), java.awt.Color.WHITE);
        ButtonStyler.applySoft(backButton, new java.awt.Color(229, 250, 239), new java.awt.Color(22, 163, 74), new java.awt.Color(187, 247, 208));
        estimateButton.setIcon(UITheme.rideIcon());
        orderButton.setIcon(UITheme.rideIcon());
    ...
    private void placeOrder() {
        ...
        if (!rideService.canAffordRide(currentUser, fare)) {
            javax.swing.JOptionPane.showMessageDialog(this, "Saldo tidak cukup untuk melakukan perjalanan ini.", "Peringatan", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }

        int confirmation = javax.swing.JOptionPane.showConfirmDialog(this,
                "Total tarif: Rp" + String.format("%,.2f", fare) + "\nKonfirmasi pemesanan?",
                "Konfirmasi",
        ...
        if (confirmation == javax.swing.JOptionPane.YES_OPTION) {
            ...
            transaction.setVehicleType("GoRide");
            ...
            if (success) {
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Pemesanan berhasil!", "Informasi", javax.swing.JOptionPane.INFORMATION_MESSAGE);
